        ...
        <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="space-y-3">
                  ...
                  {(business.complianceChecks as any)?.zoneCheck?.message && (
                    <div className="rounded-lg bg-orange-50 p-3">
                      <p className="text-xs font-semibold uppercase tracking-wide text-orange-900">Notes</p>
                      <p className="mt-1 text-sm text-orange-800">{(business.complianceChecks as any).zoneCheck.message}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <Link
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-orange-600 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-orange-700"
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="rounded-2xl border border-orange-200 bg-orange-50 p-6">
              <div className="flex gap-3">
                <svg className="h-6 w-6 flex-shrink-0 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div>
                  <h4 className="text-sm font-bold text-orange-900">Need Assistance?</h4>
