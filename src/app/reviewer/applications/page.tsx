        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/reviewer" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">Applications Review</h1>
                <p className="text-xs font-medium text-slate-500">Reviewer Dashboard</p>
              </div>
            </Link>
          </div>
          <Link
                ...
                <tbody className="divide-y divide-slate-100">
                  {filteredBusinesses.map((business) => (
                    <tr key={business.id} className="group transition-colors hover:bg-slate-50">
                      ...
                      <td className="whitespace-nowrap px-6 py-4">
                        <Link
                          href={`/reviewer/applications/${business.id}`}
